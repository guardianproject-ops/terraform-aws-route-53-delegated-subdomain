...
# terraform-aws-route-53-delegated-subdomain
...
Terraform module for delegating a subdomain from one AWS account to another
...
When you use one AWS account to hold your Route 53 zone for your domain, but you want to control and use a subdomain
in a different account, use this module to delegate control of the subdomain to your workload account
...
| Name | Version |
|------|---------|
| <a name="provider_aws.root_domain_account"></a> [aws.root\_domain\_account](#provider\_aws.root\_domain\_account) | >= 5.78.0 |
| <a name="provider_aws.subdomain_account"></a> [aws.subdomain\_account](#provider\_aws.subdomain\_account) | >= 5.78.0 |
...
| <a name="input_root_domain"></a> [root\_domain](#input\_root\_domain) | The root domain to create the subdomain under. Example: example.com | `string` | n/a | yes |
| <a name="input_stage"></a> [stage](#input\_stage) | ID element. Usually used to indicate role, e.g. 'prod', 'staging', 'source', 'build', 'test', 'deploy', 'release' | `string` | `null` | no |
| <a name="input_subdomain"></a> [subdomain](#input\_subdomain) | The subdomain to create. Example: foobar | `string` | n/a | yes |
| <a name="input_tags"></a> [tags](#input\_tags) | Additional tags (e.g. `{'BusinessUnit': 'XYZ'}`).<br/>Neither the tag keys nor the tag values will be modified by this module. | `map(string)` | `{}` | no |
| <a name="input_tenant"></a> [tenant](#input\_tenant) | ID element \_(Rarely used, not included by default)\_. A customer identifier, indicating who this instance of a resource is for | `string` | `null` | no |
| <a name="input_ttl"></a> [ttl](#input\_ttl) | The TTL of the NS record. | `number` | `3600` | no |

## Outputs

| Name | Description |
|------|-------------|
| <a name="output_domain"></a> [domain](#output\_domain) | Full name of the subdomain (subdomain + root domain). Example: foobar.example.com |
| <a name="output_zone_id"></a> [zone\_id](#output\_zone\_id) | The Route 53 zone ID of the subdomain hosted zone |
<!-- markdownlint-restore -->
...
File a GitLab [issue](https://gitlab.com/guardianproject-ops/terraform-aws-route-53-delegated-subdomain/-/issues), send us an [email][email] or join our [Matrix Community][matrix].
...
Please use the [issue tracker](https://gitlab.com/guardianproject-ops/terraform-aws-route-53-delegated-subdomain/-/issues) to report any bugs or file feature requests.
...
<!-- markdownlint-disable -->
  [website]: https://guardianproject.info/?utm_source=gitlab&utm_medium=readme&utm_campaign=guardianproject-ops/terraform-aws-route-53-delegated-subdomain&utm_content=website
  ...
  [readme_header_link]: https://guardianproject.info?utm_source=gitlab&utm_medium=readme&utm_campaign=guardianproject-ops/terraform-aws-route-53-delegated-subdomain&utm_content=readme_header_link
  [readme_commercial_support_img]: https://www.sr2.uk/readme/paid-support.png
  [readme_commercial_support_link]: https://www.sr2.uk/?utm_source=gitlab&utm_medium=readme&utm_campaign=guardianproject-ops/terraform-aws-route-53-delegated-subdomain&utm_content=readme_commercial_support_link
